...
export class InicialMigration1682624471980 implements MigrationInterface {
    name = 'InicialMigration1682624471980'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "full_name" character varying(127) NOT NULL, "email" character varying(127) NOT NULL, "password" character varying NOT NULL, "phone_number" character varying(12) NOT NULL, "createdAt" date NOT NULL DEFAULT now(), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
